...
if __name__ == "__main__":
    ...
    entailment_model = Roberta_SES_Entailment(roberta_path='/home/ubuntu/users/yutong/models/roberta-large',
                                              ckpt_path='checkpoints/epoch=2-valid_loss=-0.2620-valid_acc_end=0.9223.ckpt',
                                              max_length=512,
                                              device_name='cpu')
    print("done.")
    print()
    print("Predicting...")
    pred = entailment_model.predict(
        "In walmart : no, you get paid biweekly",
        "walmart pays biweekly",
    )
